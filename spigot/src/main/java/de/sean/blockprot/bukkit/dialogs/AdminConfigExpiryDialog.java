...
/**
 * Expiry category of the dialog-based admin config editor.
 */
public final class AdminConfigExpiryDialog {

    private AdminConfigExpiryDialog() {}
    ...
    public static void show(@NotNull Player player, @NotNull DialogOrigin backOrigin) {
        ...
        Component title = Component.text(
            AdminConfigDialog.stripColor(Translator.get(TranslationKey.DIALOGS__ADMIN_CONFIG__CAT_EXPIRY)),
        ...
        buttons.add(AdminConfigDialog.valueBtn("world_expiry.check_interval_minutes", "world_expiry.check_interval_minutes",
            ...
            p -> AdminConfigValueDialog.openInt(p, "world_expiry.check_interval_minutes",
                AdminConfigDialog.stripColor(Translator.get(TranslationKey.DIALOGS__ADMIN_CONFIG__EXPIRY__CHECK_INTERVAL_HINT)), interval,
