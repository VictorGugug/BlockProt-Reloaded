...
| `protectable_entities` | None | Configured with `VILLAGER` by default; currently `VILLAGER` is the only compatible and supported entity type for stick-protection |
