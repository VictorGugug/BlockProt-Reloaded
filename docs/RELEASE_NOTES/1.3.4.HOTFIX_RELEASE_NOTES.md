...
- [`65fa6e3`](https://github.com/VictorGugug/BlockProt-Reloaded/commit/65fa6e39fe64ffa230b7abb3eae22c082cb5c307): Update UpdateChecker.java (visible download link in update notifications).
...
- [`2e346e2`](https://github.com/VictorGugug/BlockProt-Reloaded/commit/2e346e2754ab946295d97988326d4976d1931d90): Handle hotfix-ahead updates and refresh translations (new `ahead_hotfix` key rewords the ahead-of-release message to name the running hotfix and its base, and rewords the existing `ahead` key).
