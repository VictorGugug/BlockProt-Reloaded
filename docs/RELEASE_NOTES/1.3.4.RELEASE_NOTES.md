...
- `spigot/src/main/java/de/sean/blockprot/bukkit/TranslationKey.java`: new dialog, reload review, and pending keys
...
Dialogs:
- `AdminConfigDialog.java`: added Reload configuration button, auto_reload_delay_seconds setting, PendingConfigChanges routing
- `AdminMenuDialog.java`: routed reload button to `PendingReloadDialog`
- `AboutDialog.java`, `AdminConfigValueDialog.java`, `AuditDialog.java`, `BlockInfoDialog.java`, `BlockLockDialog.java`, `BlockSettingsDialog.java`, `DebugDialog.java`, `EntityBlockSettingsDialog.java`, `EntityFriendManageDialog.java`, `EntityInfoDialog.java`, `FriendManageDialog.java`, `InfoDialog.java`, `IntegrationsDialog.java`, `LockableCategoryDialog.java`, `LockablesDialog.java`, `ProtdelDialog.java`, `StatsDialog.java`, `UnlockDialog.java`, `UpdateDialog.java`, `UserMenuDialog.java`, `UserSettingsDialog.java`: pastel color theme applied to all dialog screens
...
- `translations_en.yml`, `translations_es.yml`: auto reload delay and pending reload review keys added
