...
- `spigot/src/main/java/de/sean/blockprot/bukkit/TranslationKey.java`: new dialog, reload review, and pending keys; short `_TITLE` display-name keys for admin config buttons; Placements keys
